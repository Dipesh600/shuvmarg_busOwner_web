...
export const getFleetAssignment = (fleetId: string) => request<{ fleet: { id: string; name: string; number: string }; assignment: { activeRevision: { id: string; layout?: SeatLayoutV3 } } | null }>(`/seat-layout-v3/fleets/${fleetId}/assignment`);
