...
export interface SeatLayoutTemplate { id: string; templateCode: string; name: string; scope: "PLATFORM" | "OPERATOR"; ownerId: string | null; vehicleCategory: VehicleCategory; status: "ACTIVE" | "ARCHIVED"; currentPublishedRevisionId: string | null; }
