...
export interface FleetFiles { vehicleVideo?: File | null; photos: { front: File | null; rear: File | null; side: File | null; cabin: File | null }; fitnessCert: File | null; insurance: File | null; bluebook: File | null; routePermit: File | null; }
