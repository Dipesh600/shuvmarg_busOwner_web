...
export default function LoginPage() {
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    if (phone === "9800000000" && password === "password") {
      setIsLoading(false);
      router.push("/dashboard");
    } else {
      setIsLoading(false);
      // For demo purposes, we'll just go to dashboard on any valid input format
      router.push("/dashboard");
    }
  };
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-[#7A1D1B] text-[13px] hover:underline font-medium">
                    Forgot Password?
                  </Link>
                </div>
              ...
              <div className="relative py-4 flex items-center">
                ...
                <span className="flex-shrink-0 mx-4 text-neutral-400 text-[13px] bg-[#F8F1E3]">New to Shuv Marg?</span>
                <div className="flex-grow border-t border-neutral-200" />
              </div>
